...
// Endpoint básico de métricas para Prometheus (puedes expandirlo con prom-client más adelante)
app.get('/api/metrics', (req, res) => {
    // Métricas básicas sin prom-client (puedes agregar prom-client después)
    const metrics = {
        uptime: process.uptime(),
    ...
    res.send(`# HELP nodejs_uptime_seconds Uptime in seconds\n# TYPE nodejs_uptime_seconds gauge\nnodejs_uptime_seconds ${metrics.uptime}\n`);
});
